...
public:
	 ...
	 * @param conf 弾パラメータ
	 */
	virtual void Encount(float in_x, float in_y, float in_r, float in_vx, float in_vy, int in_hp, const BulletPattern::ShotConfig& conf, bool in_clear);
	...
	bool IsClearOnDeath() { return clearOnDeath; }
